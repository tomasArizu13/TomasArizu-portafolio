  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        outcome: "La fuerte demanda de la encuesta validó el concepto; decidimos no llevar el club más allá.",
      ...
      {
        id: 3,
        title: "RealSync: Operación Inmobiliaria y Asistente de IA",
        problem: "Las inmobiliarias no tenían visibilidad de su operación diaria, y los agentes perdían impulso cuando no podían responder a un lead de inmediato.",
        action: "Diseñé y construí RealSync: dashboards operativos que le dan al equipo una vista en tiempo real del rendimiento, y un asistente de IA conversacional que califica leads y responde preguntas inmobiliarias al instante.",
        outcome: "Redujo el tiempo de reporte en ~30%, mejoró la eficiencia del equipo en ~15%, y le dio a la inmobiliaria un asistente siempre disponible para su flujo de leads.",
